...
> Accepted as archive decision D139, independently reconstructed (verdict ACCEPT).
...
- Independent reconstruction of both tours: ACCEPT (men),
  ACCEPT (women); accepted as archive decision
  D139. Acceptance records the extension; the registered
  claims are still the accepted eight- and six-season results.
